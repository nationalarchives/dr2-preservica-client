...
abstract class EntityClientTest[F[_], S](preservicaPort: Int, secretsManagerPort: Int, stream: Streams[S])(implicit
  ...
  "entitiesUpdatedSince" should "not return paginated values" in {
    ...
    val firstPage = <EntitiesResponse>
      ...
      <Paging>
        <Next>http://localhost:{
      preservicaPort
    }/api/entity/entities/updated-since?date=2023-04-25T00%3A00%3A00.000Z&amp;start=1000&amp;max=1000</Next>
      </Paging>
    </EntitiesResponse>
