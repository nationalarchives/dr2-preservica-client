...
object Entity {
  ...
  private abstract case class BaseRef(id: UUID, title: String, deleted: Boolean) extends Entity

  def fromType[F[_]](entityType: String, id: UUID, title: String, deleted: Boolean)(implicit
      me: MonadError[F, Throwable]
  ): F[Entity] = entityType match {
    case "IO" =>
      me.pure {
        new BaseRef(id, title, deleted) {
